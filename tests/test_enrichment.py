"""
Automated Pytest for pulse-pressure-variation-calculator Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    PulsepressurevariationcalculatorEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = PulsepressurevariationcalculatorEnrichmentSuite()
